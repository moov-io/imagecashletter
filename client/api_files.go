...
/*
FilesApiService Add CashLetter to File
...
func (a *FilesApiService) AddCashLetterToFile(ctx context.Context, fileId string, cashLetter CashLetter, localVarOptionals *AddCashLetterToFileOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param createFile Content of the X9 file (in json or raw text)
...
/*
FilesApiService Delete a CashLetter from a File
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param fileId File ID
...
func (a *FilesApiService) DeleteFileCashLetter(ctx context.Context, fileId string, cashLetterId string, localVarOptionals *DeleteFileCashLetterOpts) (*http.Response, error) {
	var (
...
/*
FilesApiService Permanently deletes a File and associated CashLetters and Bundles. It cannot be undone.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param fileId File ID
 * @param optional nil or *DeleteX9FileOpts - Optional Parameters:
 * @param "XRequestId" (optional.String) -  Optional Request ID allows application developer to trace requests through the systems logs
*/

type DeleteX9FileOpts struct {
	XRequestId optional.String
}

func (a *FilesApiService) DeleteX9File(ctx context.Context, fileId string, localVarOptionals *DeleteX9FileOpts) (*http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Delete")
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
FilesApiService Get a specific CashLetter on a FIle
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param fileId File ID
 * @param cashLetterId CashLetter ID
...
func (a *FilesApiService) GetFileCashLetter(ctx context.Context, fileId string, cashLetterId string, localVarOptionals *GetFileCashLetterOpts) (CashLetter, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
FilesApiService Get the cashLetters on a File.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param fileId File ID
...
func (a *FilesApiService) GetFileCashLetters(ctx context.Context, fileId string, localVarOptionals *GetFileCashLettersOpts) ([]CashLetter, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
FilesApiService Assembles the existing file (Cash Letters, Bundles and Controls) records, computes sequence numbers and totals. Returns plaintext file.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param fileId File ID
...
/*
FilesApiService Ping the X9 service to check if running
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
*/
