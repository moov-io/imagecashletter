...
func (a *FilesApiService) DeleteImageCashLetterFile(ctx context.Context, fileId string, localVarOptionals *DeleteImageCashLetterFileOpts) (*http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Delete")
		localVarPostBody     interface{}
		localVarFormFileName string
