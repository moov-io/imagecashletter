...
[**DeleteImageCashLetterFile**](FilesApi.md#DeleteImageCashLetterFile) | **Delete** /files/{file_id} | Permanently deletes a File and associated CashLetters and Bundles. It cannot be undone.
